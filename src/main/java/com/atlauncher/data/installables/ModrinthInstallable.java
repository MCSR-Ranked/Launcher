...
public class ModrinthInstallable extends ATLauncherFormatInstallable {
    public ModrinthInstallable(Pack pack, PackVersion packVersion, LoaderVersion loaderVersion) {
