...
public class MultiMCInstallable extends ATLauncherFormatInstallable {
    public MultiMCInstallable(Pack pack, PackVersion packVersion, LoaderVersion loaderVersion) {
