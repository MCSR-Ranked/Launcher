...
public class TechnicModpackInstallable extends ATLauncherFormatInstallable {
    public TechnicModpackInstallable(Pack pack, PackVersion packVersion, LoaderVersion loaderVersion) {
