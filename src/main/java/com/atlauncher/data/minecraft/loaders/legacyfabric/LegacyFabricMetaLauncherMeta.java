...
public class LegacyFabricMetaLauncherMeta {
    private final String version;
    private final Map<String, String> mainClass;
    private final Map<String, List<LegacyFabricLibrary>> libraries;

    LegacyFabricMetaLauncherMeta(String version, Map<String, String> mainClass,
            Map<String, List<LegacyFabricLibrary>> libraries) {
    ...
    public List<LegacyFabricLibrary> getLibraries(boolean isServer) {

        List<LegacyFabricLibrary> libraries = new ArrayList<>(this.libraries.get("common"));
