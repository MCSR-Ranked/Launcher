...
public class LegacyFabricMetaLauncherMetaTypeAdapter implements JsonDeserializer<LegacyFabricMetaLauncherMeta> {
    @Override
    public LegacyFabricMetaLauncherMeta deserialize(JsonElement json, Type type, JsonDeserializationContext context)
            throws JsonParseException {
        String version;
        Map<String, String> mainClass = new HashMap<>();
        Map<String, List<LegacyFabricLibrary>> libraries = new HashMap<>();
        ...
        return new LegacyFabricMetaLauncherMeta(version, mainClass, libraries);
    }
}
